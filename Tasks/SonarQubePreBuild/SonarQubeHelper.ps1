...
#
# Retry a specific command until it completes without exceptions. Usage:  
#
...
#
# Retry a specific command until the results is true. Returns true if the command succeded. Usage:  
#
#   $command = { GetStatus -eq "Complete" } 
#   RetryUntilTrue $command -maxRetries 30 -retryDelay 1 -Verbose
# 
#
